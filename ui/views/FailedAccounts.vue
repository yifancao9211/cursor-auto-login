...
import { RefreshCw, Trash2, AlertTriangle, ShieldAlert, BadgeInfo } from "lucide-vue-next";
    ...
    <div v-else class="flex flex-col gap-3 pb-6">
      <div v-for="acc in failedAccounts" :key="acc.email" 
        ...
        <div class="flex items-start gap-4">
          <div class="w-10 h-10 rounded-full bg-apple-danger/10 flex items-center justify-center text-apple-danger flex-shrink-0 mt-0.5">
